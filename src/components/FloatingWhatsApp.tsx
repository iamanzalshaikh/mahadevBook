export default function FloatingWhatsApp() {
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 flex flex-col items-center">
      ...
      <span className="bg-white text-navy text-xs font-bold px-2.5 py-1 rounded-md shadow-md border border-navy/5 mb-1.5 sm:mb-2 animate-bounce uppercase tracking-wide">
        Chat with Us!
      </span>
      ...
      <a
        ...
        className="relative flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 bg-[#25D366] text-white rounded-full shadow-2xl hover:scale-110 active:scale-95 hover:bg-[#20ba59] transition-all duration-300 group"
